...
__copyright__ = "Copyright 2021, Revecca Iglesias-Flores"
__credits__ = ["Rebecca Iglesias-Flores"]
__license__ = "MIT"
__version__ = "0.1.0"
__maintainer__ = "Andrew King"
__email__ = ["irebecca@seas.upenn.edu","acking@utexas.edu"]
__status__ = "Dev"
...
--var_tracker_fname CDSFileName.xlsx \
--dataDir data/ \
--outDir out/ \
...
def register_arguments():
    ...
    parser.add_argument(
        ...
        required=True,
        help="Filename of the excel variable tracker file. ex. 'CDSFileName.xlsx'"
        )
    parser.add_argument(
        '--dataDir', type=str,
        required=True,
...
def run():
    ...
    for i, sheet_name in enumerate(relevant_sheets):
        ...
        # Columns: [CUSTOMER:, Unnamed: 1, User_Name, Unnamed: 3, Unnamed: 4]
